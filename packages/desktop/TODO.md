...
| 5 | **Рефакторинг компонентов** | Низкий | Разбить монолитный App.tsx на отдельные компоненты (Player, MatchMenu, WaveSettings и т.д.) для безопасного редизайна |
| 6 | **Обновление дизайна** | Низкий | Переработать визуальный стиль плеера |
